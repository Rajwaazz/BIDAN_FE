...
<div class="bg-gradient-to-br from-cyan-500 to-blue-600 py-6 px-6 sm:py-16 sm:px-8">
    <div class="container mx-auto pt-40">
        <h1
            class="text-4xl font-extrabold text-center mb-16 text-white bg-blue-600 p-6 rounded-xl max-w-2xl mx-auto">
            Daftar Pengumuman
        </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card border rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow">
                <div class="card-header p-4 bg-gradient-to-b from-blue-600 to-cyan-500 text-white rounded-t-lg">
